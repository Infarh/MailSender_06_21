...
namespace MailSender.Reports
{
    ...
    {
        public int MailSendedCount { get; set; }
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00724695", RsidParagraphAddition = "00057E8C", RsidParagraphProperties = "00D04108", RsidRunAdditionDefault = "00D04108", ParagraphId = "6A2EDEE8", TextId = "53F2F641" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00724695" };
            ...
            text1.Text = "Статистика работы ";

            run1.Append(runProperties1);
            run1.Append(text1);
            ProofError proofError1 = new ProofError() { Type = ProofingErrorValues.SpellStart };

            Run run2 = new Run() { RsidRunProperties = "00724695" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00D04108", RsidParagraphProperties = "00D04108", RsidRunAdditionDefault = "00D04108", ParagraphId = "2ADE10A7", TextId = "4C961DA3" };

            Run run3 = new Run();
            Text text3 = new Text();
            text3.Text = $"Отправлено писем – {MailSendedCount}";

            run3.Append(text3);

            paragraph2.Append(run3);

            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00D04108", RsidParagraphProperties = "00D04108", RsidRunAdditionDefault = "00D04108", ParagraphId = "4C138A95", TextId = "5A909594" };

            Run run4 = new Run();
            Text text4 = new Text();
            text4.Text = $"Серверов в БД – {ServersCount}";

            run4.Append(text4);

            paragraph3.Append(run4);

            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "00D04108", RsidParagraphAddition = "00D04108", RsidParagraphProperties = "00D04108", RsidRunAdditionDefault = "00D04108", ParagraphId = "4765EE1C", TextId = "7DF5617E" };

            Run run5 = new Run();
            Text text5 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            text5.Text = "Отчёт составил: ";
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00D04108", RsidR = "00D04108" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "002A28EB" };
            Rsid rsid1 = new Rsid() { Val = "00057E8C" };
            Rsid rsid2 = new Rsid() { Val = "002A28EB" };
            Rsid rsid3 = new Rsid() { Val = "00724695" };
            Rsid rsid4 = new Rsid() { Val = "008D68B1" };
            Rsid rsid5 = new Rsid() { Val = "00D04108" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "24FEFF8B" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{1AACA403-D9B9-480C-B049-0F8DE8279BFA}" };
        ...
        {
            document.PackageProperties.Creator = UserName ?? "";
            ...
            document.PackageProperties.LastModifiedBy = UserName ?? "";
        }
    }
}
